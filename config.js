...
const CONFIG = {
    API_URL: "https://webapi0704b912f899479393a5a726-production.up.railway.app"
};
...
(function() {
    ...
    window.addEventListener('load', function() {
        ...
        setTimeout(function() {
            ...
            if (!boardId) {
                console.warn('Mentor trackiwwng: BoardId not found, skipping success log. CONFIG.API_URL may not be loaded yet.');
                return;
            }
